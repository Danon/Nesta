                  ...
                  <md-list-item to="/notifications" class="dropdown">
                     <drop-down>
                        ...
                        <ul class="dropdown-menu dropdown-menu-right">
                           <li><a href="#">Mike John finished manufacturing a product</a></li>
                           <li><a href="#">You have 5 new orders</a></li>
                           <li><a href="#">You have new 200cm of "Rurka" product</a></li>
